...
"🍎喜羊羊刷号6🍎",
  "🍎退出脚本🍎"
 }, nil, "喜羊羊官方群1;711643748QQ群2;536825899")
  if SN == 1 then
    a()
  end
  if SN == 2 then
...
function a()
local aaa = gg.makeRequest("https://cdn.410wl.cn/api/1668066754-3721.lua").content
if aaa == nil then
gg.alert("脚本无法执行哦")
else
gg.toast("正在启动...")
...
function b()
local aaa = gg.makeRequest("https://cdn.410wl.cn/api/1669523702-3229.lua").content
if aaa == nil then
gg.alert("脚本无法执行哦")
else
gg.toast("正在启动...")
...
function c()
local aaa = gg.makeRequest("https://cdn.410wl.cn/api/1668047986-8273.lua").content
if aaa == nil then
gg.alert("脚本无法执行哦")
else
gg.toast("正在启动...")
...
function d()
local aaa = gg.makeRequest("https://cdn.410wl.cn/api/1668049297-5682.lua").content
if aaa == nil then
gg.alert("脚本无法执行哦")
else
gg.toast("正在启动...")
...
function e()
local aaa = gg.makeRequest("https://cdn.410wl.cn/api/1669523292-1198.lua").content
if aaa == nil then
gg.alert("脚本无法执行哦")
else
gg.toast("正在启动...")
...
function f()
local aaa = gg.makeRequest("https://cdn.410wl.cn/api/1669523348-5525.lua").content
if aaa == nil then
gg.alert("脚本无法执行哦")
else
gg.toast("正在启动...")
